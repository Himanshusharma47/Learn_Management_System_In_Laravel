            ...
            <div class="container mt-5">
              ...
              <div class="card shadow p-4 mb-4">
                ...
                <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group mb-3">
                    <label for="upload_file">Upload Assignments</label>
                    <input type="file" class="form-control" id="upload_file" placeholder="Upload Files">
                  </div>
              ...
              <div class="card shadow p-4 mb-4">
                ...
                <div class="mt-4">
                  ...
                  <p><strong>Assignment File:</strong> Files</p>
